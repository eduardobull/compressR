...
RcppExport SEXP _compressR_impl_zstdCompress(SEXP objectSEXP, SEXP levelSEXP) {
BEGIN_RCPP
...
RcppExport SEXP _compressR_impl_zstdUncompress(SEXP rawSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
static const R_CallMethodDef CallEntries[] = {
    {"_compressR_impl_zstdCompress", (DL_FUNC) &_compressR_impl_zstdCompress, 2},
    {"_compressR_impl_zstdUncompress", (DL_FUNC) &_compressR_impl_zstdUncompress, 1},
    {NULL, NULL, 0}
};

RcppExport void R_init_compressR(DllInfo *dll) {
